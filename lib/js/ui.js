...
function diceAdd(){
  ...
  newDice.innerHTML = `<button onclick="formSubmit('dice-button-${n}');"></button><textarea class="form-comm" id="dice-button-${n}" data-lock="full" rows="1"></textarea><i onclick="lockTypeChange(1);"></i></div>`;
