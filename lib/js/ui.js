...
function diceAdd(){
  ...
  newDice.innerHTML = `<button onclick="formSubmit('dice-button-${n}');"></button><input type="text" value="2d6" class="form-comm" id="dice-button-${n}" data-lock="on"></div>`;
  document.querySelector("#main-form .form-dice").appendChild(newDice);
}
function diceDel(){
      ...
      <div class="sheet-body">
        ...
        <div class="status-remocon-area">
          ...
          <ul>${statusRemoconArea}
            ...
            <li class="dice-button half">
              <button onclick="commSend('@cancel',0,'${unitNameEscaped}',unitList['${unitNameEscaped}']['color']);">×</button><input type="text" value="@cancel" readonly>
            </li>
          </ul>
        </div>
